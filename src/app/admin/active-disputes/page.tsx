...
export default function Dispute() {
  ...
  const fetchDisputes = async () => {
    try {
      const res = await axios.get(`${API_URL}/dispute/all`);
      ...
      <div className="h-max py-2 flex justify-end  gap-4 mt-10 mr-4 d-flex ">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="w-[150px] h-[45px] bg-[#1380FF] text-[#ffff] font-bold   rounded-lg"
          >
              ...
              >
                ...
                <p className="w-[5%]">
                  <button
                    ...
                    onClick={() => handleViewContent(dispute.equifax_letter)}
                  >
                    VIEW
                  </button>
                </p>
                <p className="w-[5%]">
                  <button
                    className="text-blue-400 underline"
                    onClick={() => handleViewContent(dispute.experian_letter)}
                  >
                    VIEW
                  </button>
                </p>
                <p className="w-[5%]">
                  <button
                    className="text-blue-400 underline"
                    onClick={() =>
                      handleViewContent(dispute.trans_union_letter)
                    }
                  >
                    VIEW
                  </button>
                ...
                <p className="w-[5%]">
                  <button
                    className="text-blue-400 underline"
                    onClick={() => handleViewContent(dispute.equifax_report)}
                  >
                    VIEW
                  </button>
                </p>
                <p className="w-[5%]">
                  <button
                    className="text-blue-400 underline"
                    onClick={() => handleViewContent(dispute.experian_report)}
                  >
                    VIEW
                  </button>
                </p>
                <p className="w-[5%]">
                  <button
                    className="text-blue-400 underline"
                    onClick={() => handleViewContent(dispute.transUnion_report)}
                  >
                    VIEW
                  </button>
                </p>
