		...
		<>
			{isLoading ? (
				<>
					<div
						className={
							"bg-white flex h-screen justify-center items-center "
						}
					>
						<svg
							aria-hidden="true"
				...
				>
					<div className="w-full justify-center text-center text-4xl">
						EMBARK ON YOUR{" "}
						<span className=" text-red-800">"BUSINESS CREDIT"</span>{" "}
						SCALING JOURNEY.
					</div>
					<div className="flex flex-col w-full justify-center content-center items-center">
						<div className="w-[75%] justify-center text-center text-2xl mt-8">
							Your Journey Begins Here With TGI Scale ME, The Key
							To Scaling Up Your{" "}
                  ...
                  Number(data?.data[3]?.fullPrice)}  */}
							...
							>
								{linksButton?.map((e: any, index: any) => {
									return (
										<div
											className="flex flex-row my-[20px]"
											key={index}
										>
											<ArrowForward
												style={{
							...
							<div className="flex w-[80%] rounded-full mt-8">
								<button
									...
									style={{
										boxShadow:
											"rgba(255, 183, 3, 0.65) 4px 6px 20px 1px",
										borderRadius: "4rem"
									}}
								>
									Choose Plan
               ...
               p-4"
						>
							...
							<div className="flex w-[80%] justify-center content-center items-center scaling-specialists-paragraph">
								We're experts at scaling up credit and
               ...
               p-4"
						>
							...
							<div className="flex w-[80%] justify-center content-center items-center scaling-specialists-paragraph">
								Our strategies are customized to your unique
								credit goals and needs
							</div>
						</div>
						<div
							className="flex flex-col w-[360px] h-[290px] justify-center content-center items-center text-center bg-[#FAFAFA]
               p-4"
						>
							...
							<div className="flex w-[80%] justify-center content-center items-center scaling-specialists-paragraph">
								Our track record of success showcases the
								results we deliver
							</div>
						</div>
						<div
               ...
               p-4"
						>
							...
							<div className="flex w-[80%] justify-center content-center items-center scaling-specialists-paragraph">
								Scaling your credit means unlocking better
               ...
               p-4"
						>
							...
							<div className="flex w-[80%] justify-center content-center items-center scaling-specialists-paragraph">
								Stay updated on your scaling journey with
