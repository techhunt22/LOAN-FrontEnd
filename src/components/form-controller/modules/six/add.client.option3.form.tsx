            ...
            {accountIsSameForAll ? (
              ...
              <div className="flex flex-col gap-2 mt-2">
                ...
                <input
                  ...
                  onChange={(e) => {
                    setTransUnionAccountNumber(e.target.value);
                  }}
                />
...
export const AddClientOption3Form = () => {
  ...
  const handleChange = (e: any) => {
    ...
    const user = userData.find(
      (item) => `${item.first_name} ${item.last_name}` === selectedValue
    );
    if (user) {
  ...
  const handleSelectChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    const letter_name = disputeItems?.find(
  ...
  const updateContent = (templateContent: string, bureau: string) => {
    ...
    const updatedContent = templateContent
      .replaceAll("{client_first_name}", selectedUserData?.first_name || "")
        ...
        <div className="w-full h-full flex flex-col items-center gap-8 justify-start">
            ...
            >
              ...
              <div className="flex gap-2">
                <input
                  ...
                  name="credit"
                  id="burea1"
                  checked={letterRecipient === "Credit Bureau"}
                  onChange={() => {
                    setLetterRecipient("Credit Bureau");
                  }}
                />
                <p className="text-[#686666] text-[20px]">Credit Bureau</p>
              </div>
              <div className="flex gap-2">
                <input
                  type="checkbox"
                  name="credit"
                  id="burea2"
                  checked={letterRecipient === "Credit Furnisher"}
                  onChange={() => {
              ...
              {disputeDetails && (
                <div className="w-full pb-10 bg-white">
                  <div className="w-full flex border-b-2 font-bold">
                    <p className="w-[20%] text-center">Creditor/Furnisher</p>
                    <p className="w-[20%] text-center">Account</p>
                    <p className="w-[15%] text-center">Reason</p>
                    <p className="w-[13%] text-center">Equifax</p>
                    <p className="w-[13%] text-center">Experian</p>
                    <p className="w-[13%] text-center">TransUnion</p>
                  </div>
                  <div className="w-full flex items-center border-b-2">
                    ...
                    <p className="w-[20%] text-center text-wrap">
                      {disputeDetails?.accountIsSameForAll
                        ? disputeDetails?.accountNumber || "N/A"
                        : `${disputeDetails?.equifaxAccountNumber || "N/A"}, ${
                            disputeDetails?.experianAccountNumber || "N/A"
                          }, ${
                            disputeDetails?.transUnionAccountNumber || "N/A"
                          }`}
                    </p>
          ...
          <div className="w-full md:w-9/12 h-full pb-6 rounded-lg flex flex-col items-center justify-start border-[#686666] border-[1px] relative mt-20 ">
            ...
            <div className="w-[90%] flex items-center justify-between px-2">
              ...
              <button
                onClick={addDispute}
                className="w-[200px] h-[50px] rounded-xl  bg-[#1380FF] text-white font-bold"
              >
                Send letter
              </button>
            </div>
