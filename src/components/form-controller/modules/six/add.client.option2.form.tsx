            ...
            <div className="w-[80%] h-max py-2 flex flex-col mt-1 gap-4 items-center bg-white rounded-lg shadow-md">
              ...
              <div className="w-[80%] h-max py-2 flex flex-col gap-2">
                ...
                <p className="text-[#a3a3a3] text-[10px]">
                  The account status on my credit report for [Account Name] is
                  incorrect. It is currently marked as "Late" for [Month/Year],
                  but I made the payment on time, and there should be no late
                  payment reported for that period. This error is negatively
                  impacting my credit score, and I kindly request that it be
                  corrected
                </p>
              </div>
          ...
          <div className="div2 w-[30%]  h-max py-2 gap-4 xl:flex hidden items-center justify-start pt-10 flex-col">
            <div className="w-[80%] h-[400px] bg-white rounded-lg shadow-md flex gap-8 pt-4 flex-col  items-center ml-3">
              ...
              <div className="w-full h-max flex items-center justify-center gap-4 ">
                ...
                <div>
                  <h1 className="text-[14px]">David Blackman</h1>
