      ...
      label: (
        <>
          ...
          <p style={{ color: "white" }} className="font-light">
            Once you’ve mailed your dispute letter, make sure to mark your
            letter as SENT
          </p>
        </>
      ),
        ...
        <div className="w-full h-full flex  items-start  mt-10">
          <div className="div1  w-full lg:w-[70%] h-full  flex flex-col items-center">
            ...
            {selectedUser?.map((item: any, index: any) => (
              <div
                className="w-[80%] h-max py-2 mb-4 flex flex-col mt-1 gap-4 items-center bg-white rounded-md shadow-md"
                key={index}
              >
                <select
                  name="this week"
                  id="1"
                  className="bg-[#F1F1F1] w-[120px] justify-center items-center px-4 h-[30px] self-start rounded-full ml-2 mt-2"
                >
                ...
                <div className="progress w-full h-[100px] flex justify-center items-center  gap-20 ">
                  <div className="uppercase flex justify-center flex-col items-center">
                    <p
                      className={`  p-1 w-auto border-solid border-2 
										${
                      selectedDispute?.equifaxScore >= 800
                        ? "border-green-600"
                        : selectedDispute?.equifaxScore <= 700 &&
                          selectedDispute?.equifaxScore >= 400
                        ? "border-yellow-600"
                        : "border-red-600"
                    } border-green-600 text-center rounded-full`}
                    >
                      {selectedDispute?.equifaxRating}:
                      {selectedDispute?.equifaxScore}
                    </p>
                  ...
                  <div className="uppercase flex justify-center flex-col items-center">
                    <p
                      className={` p-1 w-auto border-solid border-2 
										${
                      selectedDispute?.experianScore >= 800
                        ? "border-green-600"
                        : selectedDispute?.experianScore <= 700 &&
                          selectedDispute?.experianScore >= 400
                        ? "border-yellow-600"
                        : "border-red-600"
                    } border-green-600 text-center rounded-full`}
                    >
                      {selectedDispute?.experianRating}:
                      {selectedDispute?.experianScore}
                    </p>
                  ...
                  <div className="uppercase flex justify-center flex-col items-center">
                    <p
                      className={` p-1 w-auto border-solid border-2
										${
                      selectedDispute?.transUnionScore >= 800
                        ? "border-green-600"
                        : selectedDispute?.transUnionScore <= 700 &&
                          selectedDispute?.transUnionScore >= 400
                        ? "border-yellow-600"
                        : "border-red-600"
                    } border-green-600 text-center rounded-full`}
                    >
                      {selectedDispute?.transUnionRating}:
                      {selectedDispute?.transUnionScore}
                    </p>
                ...
                <div className="w-[80%] h-max py-2 flex flex-col xl:flex-row items-center  gap-8">
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <p className="text-[#a3a3a3] text-[14px]">
                      {selectedDispute.reason ? selectedDispute.reason : "N/A"}
                    </p>
                  ...
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <div className="w-[100px] h-[1px] bg-[#a3a3a3] " />
                    <p className="text-[#a3a3a3] text-[14px]">
                      {selectedDispute.credit_furnisher
                        ? selectedDispute.credit_furnisher
                        : "N/A"}
                    </p>
                  ...
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <div className="w-[100px] h-[1px] bg-[#a3a3a3] " />
                    <p className="text-[#a3a3a3] text-[14px]">
                      {selectedDispute.account_number
                        ? selectedDispute.account_number
                        : "N/A"}
                    </p>
                ...
                <div className="w-[80%] h-max py-2 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-[#333333] bg-[#a3a3a3] w-[30px] h-[30px] flex justify-center items-center rounded-full">
                      {disputes.length}
                    </p>
                  </div>
                ...
                >
                  ...
                  <Button
                    ...
                    className="flex flex-col bg-[#1380ff] text-white items-center justify-center gap-1 rounded-md w-[200px] h-[60px]"
                  >
                    <CheckCircleOutlined />
                    Mark as Sent
                  </Button>
          ...
          {selectedUser?.length === 0 ? (
            ...
            <div className="div2 w-[30%] mt-[10%] mr-5  h-max py-2 gap-4 flex flex-col justify-between">
              <div className="w-[80%]  h-auto bg-white rounded-lg shadow-md flex gap-8 pt-4 flex-col  items-start">
                <h1 className="text-[#000000] ml-2 text-[20px]">
                  Recent Disputes
                </h1>
                {disputes?.slice(-3)?.map((item: any, key: any) => {
                  return (
                    <div
                      className="w-full h-max flex items-center justify-start ml-4 gap-4 "
                      key={key}
                    >
                      <CheckCircleOutlined className="text-green-600" />
                      <div>
                        <h1 className="text-[14px]">{item?.letter_name}</h1>
              ...
              <div className="w-[80%] h-[400px] bg-white rounded-lg shadow-md flex gap-8 pt-4 flex-col  items-center  justify-start">
                <div className="flex w-full px-4">
                  ...
                  <Button
                    onClick={handleTask}
                    className="  ml-1 bg-blue-500 text-white h-[40px] px-4"
                  >
                    ADD
                  </Button>
                </div>
                ...
                <div className="w-full overflow-auto">
                  {task?.map((item: any, index: any) => {
                    return (
                      <div
                        className=" flex items-center h-max justify-between  px-4 mb-2 border-2 border-[#E0E0E0] rounded-lg mx-2"
                        key={index}
                      >
                        ...
                        <div className="">
                          <Button
                            className="  text-center border-none rounded-sm mr-1 cursor-pointer"
                            onClick={() => {
                              handleUpdateTask(item._id);
                            }}
                          >
                            <CheckCircleOutlined
                              className={`${
