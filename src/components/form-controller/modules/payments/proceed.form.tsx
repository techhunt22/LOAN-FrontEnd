            ...
            >
                <div className={"w-full mt-4"}>
                    ...
                    <TextField
                        ...
                        helperText={
                            form.errors.has("streetAddress") && form.errors.get("streetAddress")
                        }
                        InputProps={{ sx: { borderRadius: '999px', fontSize: '1rem', px: '2rem' } }}
                    />
                </div>
                <div className={"w-full mt-4"}>
                    <label className="flex text-xl mb-2">Appartment No<span className="text-lg text-gray-400">&nbsp;&nbsp; Optional</span></label>
                    <TextField
                        disabled={form.busy}
                        variant="outlined"
                        ...
                        helperText={
                            form.errors.has("appartmentNo") && form.errors.get("appartmentNo")
                        }
                        InputProps={{ sx: { borderRadius: '999px', fontSize: '1rem', px: '2rem' } }}
                    />
                </div>
                ...
                <div className={"w-full mt-4"}>
                    ...
                    <TextField
                        ...
                        helperText={
                            form.errors.has("country") && form.errors.get("country")
                        }
                        InputProps={{ sx: { borderRadius: '999px', fontSize: '1rem', px: '2rem', paddingRight: '2rem' } }}
                    >
                        <MenuItem value={"male"}>United State</MenuItem>
                        <MenuItem value={"female"}>Unite Kindom</MenuItem>
                        <MenuItem value={"other"}>Vietnam</MenuItem>
                    </TextField>
                </div>
                <div className={"w-full mt-4"}>
                    ...
                    <TextField
                        ...
                        helperText={
                            form.errors.has("postalCode") && form.errors.get("postalCode")
                        }
                        InputProps={{ sx: { borderRadius: '999px', fontSize: '1rem', px: '2rem' } }}
                    />
                </div>
                ...
                <div className="flex w-full justify-center">
                    <Link href="/payments/payment" className="w-[95%]">
                        <Button
                            sx={{
                                borderRadius: '999px',
                                fontSize: '1.5rem'
