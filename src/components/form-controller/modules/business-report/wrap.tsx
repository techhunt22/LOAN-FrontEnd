...
const headerString =
  "Is everything listed correctly with your Business Credit reports?";

const alertContent =
  "Goal for this Step  is to understand how trade accounts to report. Also to fix inaccuracies with the Business Credit Bureaus.";
const alertContent1 =
...
const contentBlogCardLeft = {
  ...
  contents: [
    {
      dataString:
        "Just like personal credit, sometimes credit information is reported incorrectly onto your business credit reports. The process to update and correct your reports is different than personal credit. Business credit reports aren’t regulated like personal credit reporting is, but you’ll find that the business credit bureaus are fairly responsive.",
      dataColor: "",
      dataSize: "",
    },
    {
      dataString:
        "It’s always important to make sure any information reporting on your credit reports is correct. It is worth taking the time to correct any inaccuracies.",
      dataColor: "",
      dataSize: "",
    },
  ],
        ...
        <div className="flex flex-col w-[76%] justify-start mt-6 business-page-inner-mobileview">
          ...
          >
            ...
            <div className="flex flex-row w-[90%] my-12 justify-center gap-6  business-credit-general-card flex-wrap">
              ...
              <div className="flex  justify-center business-page-dn-number mt-24 mt-0">
                <GeneralCardSmall
                  icon="/business-account/search.svg"
                  content="Search for a business Equifax Report"
                />
