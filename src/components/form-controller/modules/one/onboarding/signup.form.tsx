				...
				>
					...
					<div className={"w-full"}>
						<TextField
							...
							helperText={
								form.errors.has("cnfPassword") &&
								form.errors.get("cnfPassword")
							}
							type={showPassword ? "text" : "password"}
							InputProps={{
								endAdornment: (
				...
				>
					...
					<div className={"w-full"}>
						<TextField
							...
							helperText={
								form.errors.has("cityName") &&
								form.errors.get("cityName")
							}
						/>
					</div>
				</div>
					...
					<div className={"w-full"}>
						<Autocomplete
							...
							value={
								stateList.find(
									(state: StateOption) =>
										state.label === form.state
								) as StateOption | undefined
							}
							renderInput={(params) => (
								<TextField
									autoComplete="off"
