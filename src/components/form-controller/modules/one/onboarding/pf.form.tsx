		...
		<div className=" select-none flex flex-col items-center justify-center md:px-[60] px-[16px]  w-full h-full">
					...
					>
						...
						>
							<div>
								...
								>
									{row.name}{" "}
									<img src="/launch-icon.png" alt="gh" />
								</a>
							</div>
						</label>
						<input
			...
			<div className="w-full flex flex-row gap-4 items-center justify-end mt-4">
				...
				<div
					...
					onClick={
						selectedRows.length === 0 ? () => {} : handleDeselectAll
					}
				>
					Clear all
				</div>
...
export const PFForm = () => {
	...
	return (
		<form
			...
			onSubmit={onSubmit}
			className={
				"mb-36   flex flex-col justify-center items-center w-full "
			}
		>
			<div
				style={{
			...
			>
				...
				>
					<div
						className={
							"p-4 rounded-b-[30px] bg-[#EB6B7A] w-[80%] h-auto"
						}
					>
						<div
							className={
								" space-y-2 w-full h-full text-center align-middle"
							}
						>
							<h3
							...
							>
								Primary accounts and be sure to pay them all on
								time. After setting up the primary accounts then
								place a freeze on all your secondary bureaus.
							</p>
						</div>
					</div>
					<div
					...
					>
						...
						>
							...
							<h3
								className={
									"uppercase text-[#085ABB] text-[32px] font-bold "
								}
							>
