		...
		<>
				...
				<div className={"relative h-fit min-w-full"}>
					...
					<div className={" py-3 px-5 absolute top-0"}>
						...
						>
							<h2
								...
								className={
									"align-top font-extrabold text-[50px] py-4"
								}
							>
								<span
									style={{
							...
							<p
								className={
									"ml-3 text-base font-medium w-[185px]"
								}
							>
                  ...
                  {Number(props?.downPaymentAmount) +
                    ...
                    Number(numericFullValue)}
						...
						<div
							className={`font-bold rounded-xl bg-white w-[81px] h-[49px] flex items-center justify-center text-[36px] ${
								props.Green
									? "text-[#2FACB0]"
									: "text-[#D12650]"
							}`}
          ...
          Validity {props?.validity || 3} months
					...
					<button
						...
						className={
							"hover:bg-gray-600 hover:text-white h-[59px] w-[245px] tracking-tight border-[1px] border-gray-400 rounded-full p-2 bg-gray-50 text-[#737373] uppercase font-semibold"
						}
					>
						Choose Plan
					</button>
				...
				<div
					style={{
						...
						background: `${
							(props.Blue &&
								"linear-gradient(to right, #88BFFF, #5083C1)") ||
							(props.Green &&
								"linear-gradient(to right, #A3E1DD, #2EC4B6)")
						}`,
						top: "50%",
						right: "-55.5%",
